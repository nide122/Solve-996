## Dubbo 配置
# 扫描包路径
<br>spring.dubbo.scan=com.jindan.dubbo

## Dubbo 应用配置
// 应用名称
<br>spring.dubbo.application.name=demo

// 模块版本
<br>spring.dubbo.application.version=0.1.0

// 应用负责人
<br>spring.dubbo.application.owner=libiqi
