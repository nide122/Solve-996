 ...
 * 图片压缩
 * @author xf
 * @date  2014-12-19上午9:48:06
 * @version 1.0
 */
public class ImageCompress {
	public static void main(String[] arg) throws IOException { 
		   Image image = ImageIO.read(new File("e:/" + "2.png"));
		   int imageWidth = image.getWidth(null);
		   int imageHeight = image.getHeight(null);
		   imageCompress("e:/", "2.png", "22.jpg", 1f, 0.1f, imageWidth, imageHeight);
	}
    /**
     * 描述：
     * 
...
//                scale = 0.5f;// 默认压缩比为0.5，压缩比越大，对内存要去越高，可能导致内存溢出
            ...
            /**new 2018-7-30*/ 
            String dstName = path + toFileName; 
            String formatName = dstName.substring(dstName.lastIndexOf(".") + 1); 
            ImageIO.write(mBufferedImage, /*"GIF"*/ formatName /* format desired */ , new File(dstName) /* target */ ); 
