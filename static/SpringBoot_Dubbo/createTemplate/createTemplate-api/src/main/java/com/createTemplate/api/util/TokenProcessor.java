...
public class TokenProcessor {
    ...
    public synchronized boolean isTokenValid(HttpServletRequest request,
        ...
        String saved =
            (String) session.getAttribute(CommonConstant.TRANSACTION_TOKEN_KEY);
        ...
        String token = request.getParameter(CommonConstant.TOKEN_KEY);
    ...
    public synchronized void resetToken(HttpServletRequest request) {
        ...
        session.removeAttribute(CommonConstant.TRANSACTION_TOKEN_KEY);
    }
    ...
    public synchronized void saveToken(HttpServletRequest request) {
        ...
        if (token != null) {
            session.setAttribute(CommonConstant.TRANSACTION_TOKEN_KEY, token);
        }
    }
